...
const ll=new Promise(((e,t)=>{Va(Zc,(t=>{t&&e(el.fetchUserById(t.uid))}))}));function ul(){if(!JSON.parse(localStorage.getItem("user")||null))return;const e=document.querySelectorAll(".gallery__list-item .js-btn-fav");console.log(e.length),ll.then((t=>{e.forEach((e=>{favId=e.dataset.id;e.dataset.favorite;t.hasFavoriteCocktailById(favId)?(_l(e,!0),e.children[0].textContent="Remove"):(_l(e,!1),e.children[0].textContent="Add to")}))})).catch((e=>{throw new Error(e.message)}))}
//! *****************************************************************************************************************
...
//# sourceMappingURL=index.f1339e18.js.map
